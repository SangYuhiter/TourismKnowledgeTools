...
def parse_data(input_file_path):
    ...
    for line in all_lines:
        # print(line)
        pass
    print("all record size:{},scenic record size:{},traveldetail record size:{}".format(len(all_lines),len(scenic_records),len(travel_detail_records)))
    ...
    for i in range(len(travel_detail_records)):
        travel_detail_sheet.write(i,0,travel_detail_records[i])
    for i in range(len(scenic_records)):
        scenic_sheet.write(i,0,scenic_records[i])
